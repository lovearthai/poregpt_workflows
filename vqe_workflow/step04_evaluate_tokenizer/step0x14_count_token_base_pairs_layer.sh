...
if [ -n "$2" ]; then
    ...
    #OUTPUT_FILE="${OUT_DIR}/step0x14_count_token_base_pairs_layer.csv"
    OUTPUT_FILE="${OUT_DIR}/step0x14_count_token_base_pairs_layer_shifted.csv"
fi
