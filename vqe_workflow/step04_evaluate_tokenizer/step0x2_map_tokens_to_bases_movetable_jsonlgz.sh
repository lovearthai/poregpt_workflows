...
INPUT_FILE="/mnt/zzbnew/poregpt/dnadata/movetable/signal_${FILE_PATTERN}.modified.reformed.shiftr4.mongoq30.${TOKENIZER_NAME}.jsonl.gz"
# 输出文件
OUTPUT_FILE="/mnt/zzbnew/poregpt/dnadata/movetable/signal_${FILE_PATTERN}.modified.reformed.shiftr4.mongoq30.${TOKENIZER_NAME}.aligned.jsonl.gz"
