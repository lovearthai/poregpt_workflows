...
MODEL_PATH="/mnt/zzbnew/poregpt/models/HF_V340S147000L1_DNA595G_C01K/foundation/base_200m"

# 输出目录
OUTPUT_DIR="step280_cal_bases_pattern_feature_by_olmo_v1"
...
OUTPUT_CSV="$OUTPUT_DIR/step280_${FILE_PATTERN}.modified.reformed.shiftr4.mongoq30.${TOKENIZER_NAME}_kmer${KMER_K}_bnum${BOUNDARY_NUM}_topn${DYNAMIC_TOP_N}_sigma${WEIGHT_SIGMA}.csv"
