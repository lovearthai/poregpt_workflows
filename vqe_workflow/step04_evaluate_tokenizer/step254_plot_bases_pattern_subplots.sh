...
INPUT_CSV=${1:-"step252_cal_bases_pattern_feature/step252_boundary0_block5_repeat2_sigma3.csv"}
...
# 输出目录
OUTPUT_DIR="step254_plot_bases_pattern_subplots"
...
# 注意：双引号引用变量以处理空格
python3 scripts/step254_plot_bases_pattern_subplots.py \
    --input "$INPUT_CSV" \
    --output "$OUTPUT_PNG" \
