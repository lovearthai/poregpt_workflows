...
base_name="base_336m"
data_name="dna595g_test_kmer9_t5000_r0.7_least1000_exclude7"
# A40
batch_size=64
# W64
batch_size=64
...
wandb_run_name="a40_${model_name}_${base_name}_${head_type}_${pre_head_type}_${feature_source}_unfreeze${unfreeze_last_n_layers}_bsz${batch_size}_nnodes${NNODES}_rank${NODE_RANK}_${data_name}_${lr}"

base_model="/mnt/zzbnew/poregpt/rna_model/${model_name}/foundation/${base_name}"
data_root="/mnt/zzbnew/poregpt/rna_model/${model_name}/basecall/${data_name}"
firstrun_dir="/mnt/zzbnew/poregpt/rna_model/${model_name}/run/${wandb_run_name}_firstrun"
resumerun_dir="/mnt/zzbnew/poregpt/rna_model/${model_name}/run/${wandb_run_name}_resumerun"

mkdir -p "${firstrun_dir}"
mkdir -p "${resumerun_dir}"
...
pretrained_ckpt="${firstrun_dir}/ckpt_last.pt"
