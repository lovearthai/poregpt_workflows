...
wandb_run_name="${model_name}_${head_type}_${pre_head_type}_${feature_source}_unfreeze${unfreeze_last_n_layers}_bsz${batch_size}_nnodes${NNODES}_rank${NODE_RANK}_basecall_kmer9_t9000_r0.3_least1000_exclude7_a40"
...
data_root="/mnt/zzbnew/rnamodel/model/signalDNAmodel/${model_name}/basecall_kmer9_t9000_r0.3_least1000_exclude7"
