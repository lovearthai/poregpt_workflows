...
torchrun --nproc_per_node=8 --rdzv_endpoint=localhost:29502 \
	scripts/train.py configs/config_150m_vqe48s67000_ctx1280_dna037g.yaml \
	--run_name="olmo-pt-bioseq-150m-dna37g-split1280_overlap1024-vqe48s67000-ctx1280-gbsz4096-lr1e4-1ep" \
        --wandb.entity="jiaoshuaihit-hit" \
        --wandb.project="bioseq-rna-80g" \
        --load_path="" \
        --save_folder="../output_150m_ctx1280-gbsz4096-lr1e4-vqe48s67000/steps/" 
