...
torchrun --nproc_per_node=8 --rdzv_endpoint=localhost:29502 \
	scripts/train.py configs/config_150m_vqe92s160000_ctx1280_dna008g_lr1e4.yaml \
	--run_name="olmo-pt-bioseq-150m-dna008g-split1280_overlap1024-vqe92s160000-ctx1280-gbsz4096-lr1e4-1ep-cnn8" \
        --wandb.entity="jiaoshuaihit-hit" \
        --wandb.project="bioseq-dna-04g" \
        --load_path="" \
        --save_folder="../output_150m_ctx1280-gbsz4096-lr1e4-vqe92s160000-008g/steps/" 
