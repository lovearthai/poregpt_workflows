...
torchrun --nproc_per_node=8 --rdzv_endpoint=localhost:29502 \
	scripts/train.py configs/config_vqe342s036000l1_cb016k_300m_ctx1280_dna595g.yaml \
	--run_name="olmo-pt-bioseq-300m-dna595g-split1280_overlap256-vqe342s036000l1-ctx1280-gbsz4096-lr1e4-1ep-cnn8" \
        --wandb.entity="jiaoshuaihit-hit" \
        --wandb.project="bioseq-dna-04g" \
        --load_path="" \
        --save_folder="../output_300m_ctx1280-gbsz4096-lr1e4-vqe342s036000l1/steps/" 
