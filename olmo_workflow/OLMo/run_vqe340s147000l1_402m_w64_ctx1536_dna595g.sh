...
torchrun --nproc_per_node=8 --rdzv_endpoint=localhost:29502 \
	scripts/train.py configs/config_402m_vqe340s147000l1_ctx1536_dna595g_mlp4_dim1024_layer24.yaml \
	--run_name="olmo-pt-bioseq-402m-dna595g-split1536_overlap256-vqe340s147000l1-ctx1536-gbsz4096-lr1e4-1ep-cnn12-mlp4-dim1024-layer24" \
        --wandb.entity="jiaoshuaihit-hit" \
        --wandb.project="bioseq-dna-04g" \
        --load_path="" \
        --save_folder="../output_402m_ctx1536-gbsz4096-lr1e4-vqe340s147000l1-mlp4-dim1024-layer24/steps/" 
