...
torchrun --nproc_per_node=8 --rdzv_endpoint=localhost:29502 \
	scripts/train.py configs/config_20m_w64_context1280_dna810g.yaml \
	--run_name="olmo-pt-bioseq-20m-dna810g-split1280_overlap640-vqe-c64k_cnn3-pass25-step22500-ctx1280-gbsz4096-lr5e4-1ep" \
        --wandb.entity="jiaoshuaihit-hit" \
        --wandb.project="bioseq-rna-80g" \
        --load_path="" \
        --save_folder="../output_20m_ctx1280-gbsz4096-lr5e4/steps/" 
