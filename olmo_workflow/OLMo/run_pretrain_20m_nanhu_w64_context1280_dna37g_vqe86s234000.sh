...
torchrun --nproc_per_node=8 --rdzv_endpoint=localhost:29502 \
	scripts/train.py configs/config_20m_vqe86s234000_ctx1280_dna37g.yaml \
	--run_name="olmo-pt-bioseq-20m-dna32g-split1280_overlap1024-vqe86s234000-ctx1280-gbsz4096-lr1e4-1ep-cnn7" \
        --wandb.entity="jiaoshuaihit-hit" \
        --wandb.project="bioseq-dna-04g" \
        --load_path="" \
        --save_folder="../output_20m_ctx1280-gbsz4096-lr1e4-vqe86s234000/steps/" 
