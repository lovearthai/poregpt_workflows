...
torchrun --nproc_per_node=8 --rdzv_endpoint=localhost:29502 \
	scripts/train.py configs/config_20m_vqe58s19000_ctx1280_dna37g.yaml \
	--run_name="olmo-pt-bioseq-20m-dna37g-split1280_overlap1024-vqe58s19000-ctx1280-gbsz4096-lr1e4-1ep" \
        --wandb.entity="jiaoshuaihit-hit" \
        --wandb.project="bioseq-rna-80g" \
        --load_path="" \
        --save_folder="../output_20m_ctx1280-gbsz4096-lr1e4-vqe58s19000/steps/" 
