...
torchrun --nproc_per_node=8 --rdzv_endpoint=localhost:29502 \
	scripts/train.py configs/config_150m_w64_context1280_dna37g.yaml \
	--run_name="olmo-pt-bioseq-150m-dna37g-split1280_overlap1024-vqe-c64k_cnn3-pass25-step22500-ctx1280-gbsz4096-lr5e4-1ep" \
        --wandb.entity="jiaoshuaihit-hit" \
        --wandb.project="bioseq-rna-80g" \
        --load_path="" \
        --save_folder="../output_150m_ctx1280-gbsz4096-lr5e4/steps/" 
