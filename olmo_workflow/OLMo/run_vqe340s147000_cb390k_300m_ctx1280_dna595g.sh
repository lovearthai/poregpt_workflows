...
torchrun --nproc_per_node=8 --rdzv_endpoint=localhost:29502 \
	scripts/train.py configs/config_vqe340s147000_cb390k_300m_ctx1280_dna595g.yaml \
	--run_name="olmo-pt-bioseq-vqe340s147000-cb390k-300m-dna595g-split1280_overlap256-ctx1280-gbsz4096" \
        --wandb.entity="jiaoshuaihit-hit" \
        --wandb.project="bioseq-dna-04g" \
        --load_path="" \
        --save_folder="../output_vqe340s147000_cb390k_300m_ctx1280_dna595g/steps/" 
