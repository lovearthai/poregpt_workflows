...
nohup torchrun --nproc_per_node=4 --rdzv_endpoint=localhost:29502 \
	scripts/train.py configs/config_60m_a100.yaml \
	--run_name="olmo2_bwavvq08k_20m_pt_batch22" \
        --wandb.entity="jiaoshuaihit-hit" \
        --wandb.project="bioseq-rna-80g" \
        --load_path="" \
        --save_folder="../output_olmo20m_pt/steps/" \
&> run_pretrain_20m.log &
