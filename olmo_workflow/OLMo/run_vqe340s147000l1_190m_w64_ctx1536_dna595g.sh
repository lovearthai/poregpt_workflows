...
torchrun --nproc_per_node=8 --rdzv_endpoint=localhost:29502 \
	scripts/train.py configs/config_190m_vqe340s147000l1_ctx1536_dna595g_mlp2_dim0768_layer32.yaml \
	--run_name="olmo-pt-bioseq-190m-dna595g-split1536_overlap256-vqe340s147000l1-ctx1536-gbsz4096-lr5e5-1ep-cnn12-mlp2-dim0768-layer32" \
        --wandb.entity="jiaoshuaihit-hit" \
        --wandb.project="bioseq-dna-04g" \
        --load_path="" \
        --save_folder="../output_190m_ctx1536-gbsz4096-lr5e5-vqe340s147000l1-mlp2-dim0768-layer32/steps/" 
