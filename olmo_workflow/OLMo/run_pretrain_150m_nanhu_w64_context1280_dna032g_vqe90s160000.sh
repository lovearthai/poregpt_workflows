...
torchrun --nproc_per_node=8 --rdzv_endpoint=localhost:29502 \
	scripts/train.py configs/config_150m_vqe90s160000_ctx1280_dna032g.yaml \
	--run_name="olmo-pt-bioseq-150m-dna032g-split1280_overlap1024-vqe90s160000-ctx1280-gbsz4096-lr1e4-1ep-cnn8" \
        --wandb.entity="jiaoshuaihit-hit" \
        --wandb.project="bioseq-dna-04g" \
        --load_path="" \
        --save_folder="../output_150m_ctx1280-gbsz4096-lr1e4-vqe90s160000/steps/" 
